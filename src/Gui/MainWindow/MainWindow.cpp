...
const char COMMUNITY_FORUM_URL[] = "https://discord.uniqnetwork.io";
const char REPORT_ISSUE_URL[] = "https://www.uniqnetwork.io";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("UniQ Wallet %1").arg(Settings::instance().getVersion()));
