...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x72a3; // addresses start with "UQ"
...
const uint64_t MONEY_SUPPLY									 = UINT64_C(8000000000000000); // 80M
const uint64_t FINAL_SUBSIDY_PER_MINUTE						 = UINT64_C(20000000); // 0.20 UNIQ
...
const char     CRYPTONOTE_NAME[]                             = "UniQ";
...
const int      P2P_DEFAULT_PORT                              =  62600;
const int      RPC_DEFAULT_PORT                              =  62601;

const size_t   P2P_LOCAL_WHITE_PEERLIST_LIMIT                =  5000;
...
const char* const SEED_NODES[] = {
	"seed111.uniqnetwork.io:62600",
	"seed112.uniqnetwork.io:62600",
	"pool.uniqnetwork.io:62600",
	"45.76.241.207:62600",
	"207.246.91.106:62600"
};
...
const CheckpointData CHECKPOINTS[] = {
	{ 0, "7505c1b74caa71f65eb40a5c310a7ab5934ce3250c88d92a617815c01a402015"} // Genesis UniQ
};
}
